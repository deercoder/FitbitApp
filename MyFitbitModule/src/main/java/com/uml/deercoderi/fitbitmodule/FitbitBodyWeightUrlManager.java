 ...
 *
 *  According to the official tutorial about Body Weight Time Serias:
 ...
 *  and the correct period, which could be 1d, 7d, 1w, 1m.
 *
 ...
 */
public class FitbitBodyWeightUrlManager {

    private static final String FITBIT_BODY_WEIGHT_URL = "https://api.fitbit.com/1/user/-/body/log/fat/date/";
    ...
    public FitbitBodyWeightUrlManager() {
        initDate();
    }
     ...
     */
    public String getBodyWeightInfoUrl() {
        return FITBIT_BODY_WEIGHT_URL + mDate + ".json";
    }
